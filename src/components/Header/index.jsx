          ...
          <div className="collapse navbar-collapse" id="navbarCollapse">
            ...
            <ul className="navbar-nav mx-auto">
              ...
              <li className="nav-item dropdown position-static">
                {/* Toggle */}
                <a className="nav-link" data-toggle="dropdown" to="/catalog">
                  Catalog
                </a>
                {/* Menu */}
                  ...
                  <div className="card card-lg">
                    <div className="card-body">
                      <ul className="list-styled font-size-sm">
                        ...
                        <li className="list-styled-item">
                          <a className="list-styled-link" to="/contact">
                            Contact Us
                          </a>
                        </li>
                        <li className="list-styled-item">
                          <a className="list-styled-link" to="/store_locator">
                            Store Locator
                          </a>
                        </li>
                        <li className="list-styled-item">
                          <a className="list-styled-link" to="/faq">
                            FAQ
                          </a>
                        </li>
                        <li className="list-styled-item">
                          <a className="list-styled-link" to="/comming-son">
                            Coming Soon
                          </a>
                        </li>
                      </ul>
